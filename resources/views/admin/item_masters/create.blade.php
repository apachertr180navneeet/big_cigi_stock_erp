            ...
            <form action="{{ route('admin.item_masters.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('cess_percentage') is-invalid @enderror" id="cess_percentage" name="cess_percentage" value="{{ old('cess_percentage') }}" />
